    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder){
        return builder.routes()
                ...
                .route("auth-service-route", r -> r.path("/auth/login")
                        .uri("lb://auth-service"))
                .route("auth-service-route", r -> r.method(HttpMethod.GET)
                        .and()
                        .path("/auth/Landing")
                        .uri("lb://auth-service"))
                ...
                .route("shipping-route", r -> r.method(HttpMethod.GET)
                        .and()
                        .path("/shipping")
                        .filters(f -> f.filter(filter.apply("ADMIN,FORNECEDOR")))
                        .uri("lb://shipping"))
                ...
                .route("shipping-route", r -> r.method(HttpMethod.GET)
                        .and()
                        .path("/shipping/**")
                        .filters(f -> f.filter(filter.apply("USER,FORNECEDOR,ADMIN")))
                        .uri("lb://shipping"))
                .route("shipping-route", r -> r.method(HttpMethod.PUT)
                        .and()
                        .path("/shipping/**")
                        .filters(f -> f.filter(filter.apply("FORNECEDOR,ADMIN")))
                        .uri("lb://shipping"))
