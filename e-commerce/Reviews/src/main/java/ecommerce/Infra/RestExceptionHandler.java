...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<String> alreadyExistingExceptionHandler(AlreadyExistingException exception){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Review already exists");
    }
    ...
    public ResponseEntity<String> noReviewsFoundException(NoReviewsFoundException exception){
